...
function getSystemPrompt(lang: "tr" | "en"): string {
  const base = {
    name: "Nisa Ataş",
    role: "Junior Backend Developer | AI & LLM Applications",
    ...
    experience: [
      "Microsoft - AI Engineer Intern (Haziran 2026 - Günümüz)",
      "Laynext - Backend Developer Intern (Haziran 2026 - Günümüz)",
