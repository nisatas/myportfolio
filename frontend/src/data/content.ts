...
export const content: Record<Lang, any> = {
  tr: {
    ...
    hero: {
      ...
      subtitle: "Junior Backend Developer | AI & LLM Applications",
      description: "RESTful API geliştirme, veritabanı yönetimi, authentication ve AI entegrasyonlarına odaklanan Junior Backend Developer adayıyım. Node.js, Express.js, TypeScript, Java Spring Boot, Prisma ve SQL teknolojileriyle backend projeleri geliştiriyor; AI/LLM destekli uygulamalarda backend entegrasyonu ve veri odaklı sistemler üzerine çalışıyorum.",
      ...
      items: [
        {
          ...
          company: "Microsoft",
          period: "Remote | Haziran 2026 - Günümüz",
          description: "Microsoft Türkiye AI Innovators Summer Internship Program kapsamında LLM, RAG mimarisi, Microsoft Foundry Local, vector search ve prompt engineering konularında çalışmalar yürütüyorum. AI destekli uygulama geliştirme, backend entegrasyonu ve veri odaklı AI workflow süreçleri üzerine uygulamalı deneyim kazanıyorum.",
          technologies: ["LLM", "RAG", "Microsoft Foundry Local", "Vector Search", "Prompt Engineering"],
        },
        {
          position: "Backend Developer Intern",
          company: "Laynext",
          period: "Remote | Haziran 2026 - Günümüz",
          description: "Laynext'te Backend Developer Intern olarak yenilikçi yazılım projelerinin backend geliştirme süreçlerinde yer alıyorum.",
          technologies: ["Node.js", "Express.js", "TypeScript", "Backend", "REST API"],
        },
        {
  ...
  en: {
    ...
    hero: {
      title: "Hi, I'm Nisa",
      subtitle: "Junior Backend Developer | AI & LLM Applications",
      description: "I am a Junior Backend Developer candidate focused on RESTful API development, database management, authentication, and AI integrations. I develop backend projects using Node.js, Express.js, TypeScript, Java Spring Boot, Prisma, and SQL, while working on backend integrations and data-driven systems for AI/LLM-powered applications.",
      ...
      items: [
        {
          position: "AI Engineer Intern",
          company: "Microsoft",
          period: "Remote | June 2026 - Present",
          description: "Participating in the Microsoft Türkiye AI Innovators Summer Internship Program, focusing on LLMs, RAG architecture, Microsoft Foundry Local, vector search, and prompt engineering. Gaining hands-on experience in AI-powered application development, backend integration, and data-driven AI workflows.",
          technologies: ["LLM", "RAG", "Microsoft Foundry Local", "Vector Search", "Prompt Engineering"],
        },
        {
          position: "Backend Developer Intern",
          company: "Laynext",
          period: "Remote | June 2026 - Present",
          description: "Working as a Backend Developer Intern at Laynext, contributing to the backend development processes of innovative software projects.",
          technologies: ["Node.js", "Express.js", "TypeScript", "Backend", "REST API"],
        },
        {
          position: "Full Stack Developer Trainee",
