...
function fallbackAnswer(lang: "tr" | "en", q: string) {
  ...
  if (lang === "tr") {
    ...
    if (jobIntent.test(s)) return "Şu an Microsoft'ta AI Engineer Intern, Laynext'te Backend Developer Intern, Workintech'te Full Stack Developer Trainee ve AUZEM YETAM XR'da öğrenci asistanı olarak devam ediyorum.";
    ...
    if (whoIntent.test(s) || s.includes("nisa")) return "Ben Nisa Ataş. Junior Backend Developer adayıyım; RESTful API, veritabanı, authentication ve AI entegrasyonları üzerine çalışıyorum. Node.js, Express.js, TypeScript, Spring Boot, Prisma ve SQL ile backend projeleri geliştiriyorum.";
    ...
    if (s.includes("deneyim") || s.includes("çalışma")) return "Microsoft'ta AI Engineer Intern, Laynext'te Backend Developer Intern, Workintech'te Full Stack Developer Trainee olarak çalışıyorum. Ayrıca AUZEM - YETAM XR'da öğrenci asistanı, Robotik Bilim'de robotik kodlama öğretmeni ve Şişli Öğretmenevi'nde eğitmen deneyimlerim var.";
    if (s.includes("iş") || s.includes("workintech")) return "Microsoft'ta AI Engineer Intern, Laynext'te Backend Developer Intern ve Workintech'te Full Stack Developer Trainee olarak devam ediyorum. Ayrıca AUZEM - YETAM XR'da öğrenci asistanıyım.";
    ...
    if (jobIntentEn.test(s)) return "Right now I'm an AI Engineer Intern at Microsoft, a Backend Developer Intern at Laynext, a Full Stack Developer Trainee at Workintech, and a student assistant at AUZEM YETAM XR.";
    ...
    if (s.includes("who") || s.includes("about") || s.includes("nisa") || s.includes("tell me about")) return "I'm Nisa Ataş, a Junior Backend Developer candidate focused on RESTful APIs, databases, authentication, and AI integrations. I build backend projects with Node.js, Express.js, TypeScript, Spring Boot, Prisma, and SQL.";
    ...
    if (s.includes("experience") || s.includes("work") || s.includes("workintech") || s.includes("job")) return "I'm an AI Engineer Intern at Microsoft, a Backend Developer Intern at Laynext, and a Full Stack Developer Trainee at Workintech. I also have experience as a student assistant at AUZEM - YETAM XR, robotics coding teacher at Robotics Science, and instructor at Şişli Teachers' House.";
